...
<div class="col-sm-12">
    <div class="card">
        <div class="card-header pb-0">
            ...
            <span>
                Berisi data kriteria dan bobot.
            </span>
            <hr>
        </div>
            ...
            <form class="needs-validation" action="{{route('bobot.update')}}" method="post"
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        ...
                        <input type="kriteria" name="kriteria" class="form-control"
                            aria-describedby="kriteria" value="{{ $item->nama_kriteria }}" style="width: 95%" disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label" for="bobot">Bobot {{$item->id}}</label>
                        <input type="bobot" name="bobot-{{$item->id}}" class="form-control bobot" style="width: 95%"
                            aria-describedby="bobot" value="{{ $item->bobot }}">
                    </div>
                </div>
                <br>
                @endforeach
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        ...
                        <input type="total-bobot" name="total-bobot" class="form-control"
                            aria-describedby="kriteria" value="Total Bobot" style="width: 95%" disabled>
                    </div>
