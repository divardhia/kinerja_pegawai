    ...
    <div class="main-header-right row m-0">
        <div class="main-header-left">
            {{-- <div class="logo-wrapper"><a href="{{route('home')}}"><img class="img-fluid"
                        src="{{ asset('viho') }}/assets/images/logo/logo.png" alt=""></a></div>
        ...
        <div class="nav-right col pull-right right-menu p-0">
            <ul class="nav-menus">
                ...
                <li>
                    ...
                    <input type="text" name="check_mode" id="check_mode" value="{{$general->dark_mode}}" hidden>
                </li>
                {{-- <li class="onhover-dropdown">
                    ...
                    <ul class="chat-dropdown onhover-show-div">
                        <li>
                            <div class="media">
                                <img class="img-fluid rounded-circle me-3"
                                    src="{{ asset('viho') }}/assets/images/user/4.jpg" alt="">
                                <div class="media-body">
                        ...
                        <li>
                            <div class="media">
                                <img class="img-fluid rounded-circle me-3"
                                    src="{{ asset('viho') }}/assets/images/user/1.jpg" alt="">
                                <div class="media-body">
                        ...
                        <li>
                            <div class="media">
                                <img class="img-fluid rounded-circle me-3"
                                    src="{{ asset('viho') }}/assets/images/user/2.jpg" alt="">
                                <div class="media-body">
